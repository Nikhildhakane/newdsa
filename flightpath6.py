# Experiment No. 6: There are flight paths between cities. If there is a flight between 
# city A and city B then there is an edge between the cities. The cost of the edge can 
# be the time that flight take to reach city B from A, or the amount of fuel used for 
