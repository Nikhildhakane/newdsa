/*Experiment No.1: Consider telephone book database of N clients.Make use of a hash table
...
class hashing{
 ...
 // Function to search for a record based on name input 
