# Experiment No:2 =Implement all the functions of a dictionary (ADT) using hashing and handle collisions 
# using chaining with / without replacement. Data: Set of (key, value) pairs, Keys are mapped to values,
